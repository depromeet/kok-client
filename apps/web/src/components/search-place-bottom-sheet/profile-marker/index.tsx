...
const ProfileMarker = ({
  ...
  markerElement.innerHTML = `
    <div style="position: relative;">
      ...
      <div style="position: absolute; left: 50%; bottom: -2px; border-radius: 2px; width: 16px; height: 16px; background-color: ${theme.colors.navy}; transform: translateX(-50%) rotate(45deg); z-index: -1;" />
    </div>
  `;
